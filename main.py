...
while user_input != 0:
    print("\nEnter '1' to Show the Seats\nEnter '2' to Choose the movie\nEnter '3' to Choose movie language\nEnter '4' to Show the time\nEnter '5' to Buy a Ticket\nEnter '6' to Statistics\nEnter '7' to Show booked Tickets User Info\nEnter '0' to Exit")
    print(50*"-")
...
# New object is created for the Theater class in theater_info.py 
        ...
        if t.book_row<=no_of_rows and t.book_column<=no_of_seats :
            b,current_income=t.buy_ticket(total_seats,no_of_rows,total_income)
            if b != None:
